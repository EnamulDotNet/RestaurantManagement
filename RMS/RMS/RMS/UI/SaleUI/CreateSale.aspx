...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <asp:Panel runat="server" ID="pnlId" style="margin-bottom: 10px; text-align: center;">
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <asp:HiddenField runat="server" ID="hfdCustomerId" Value="1"/>
                </td>
                <td>
                ...
                <td>
                    <div class = "input-group">
                         ...
                         <asp:TextBox runat="server" ID="CustomerDue" CssClass="form-control" Width="120px" ReadOnly="True" Enabled="False" TabIndex="-1"></asp:TextBox>
    ...
    <asp:Panel runat="server" ID="pnlAddButton" style="margin-left: 50px;">
        <asp:Button runat="server" ID="btnAdd" Text="Add" CssClass="btn btn-primary" Width="155px" ClientIDMode="Static" OnClick="btnAdd_Click" />
    </asp:Panel>
    <hr/>
    ...
    <br/>
    <asp:Panel runat="server" ID="pnlsale" style="margin-left: 50px;" Visible="false">
        <asp:Button runat="server" ID="btnSell" CssClass="btn btn-primary" CausesValidation="false" Text="Sell" ClientIDMode="Static" Width="155px" OnClick="btnSell_OnClick"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </asp:Panel>
   <br />
